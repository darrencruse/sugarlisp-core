      ...
      function(vars) {
        return (function(classexpr, constructorArgs) {
          if ((constructorArgs.length === 0)) {
            return sl.generated([
              "new ", this.transpileExpression(classexpr)
            ]);
          } else {
            return sl.generated([
    ...
    when([
      ...
      function(vars) {
        return (function(condition, iftrue, iffalse) {
          return sl.generated([
            "(", this.x(condition), " ?\n",
            "    ", this.transpileCommaExpression(iftrue), " :\n",
            "    ", this.transpileCommaExpression(iffalse), ")"
          ]);
    ...
    when([
      ...
      function(vars) {
        return (function(condition, iftrue) {
          return sl.generated([
            "(", this.x(condition), " ?\n",
            "    ", this.transpileCommaExpression(iftrue), " : undefined )"
          ]);
